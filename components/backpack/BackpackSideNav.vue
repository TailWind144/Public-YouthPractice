<template>
  <div class="flex flex-col gap-1">
    <div
      class="duration-300 text-lg py-2 px-4 cursor-pointer hover:bg-[var(--bg-hover-color)] rounded"
      :class="{
        'bg-[var(--bg-hover-color)]': selectedKind === item,
      }"
    ...
    >
      <div class="flex items-center gap-2">
        <div class="text-[var(--text-h1)]">{{ `${item}物品` }}</div>
